...
export const funnelsAPI = {
  getAll: (params = {}) => {
    ...
    return apiRequest(`/funnels${queryString ? `?${queryString}` : ''}`);
  },
  
  getById: (id) => apiRequest(`/funnels/${id}`),
  ...
  duplicate: (id) =>
    apiRequest(`/funnels/${id}/duplicate`, {
      method: 'POST',
    }),
};
...
export const analyticsAPI = {
  ...
  getFunnelAnalytics: (funnelId, period = '30') =>
...
export const templatesAPI = {
  ...
  getFeatured: () => apiRequest('/templates/featured/list'),
